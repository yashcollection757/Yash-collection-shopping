          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 mb-8">
            ...
            <div className="col-span-2 lg:col-span-1">
              ...
              <div className="space-y-2 text-sm">
                <p className="font-semibold text-gray-300">📍 76/18/1 Banaras road , Jittu babu ka Godown, howrah , Kolkata (West Bengal) -711101</p>
                <div className="space-y-2 mt-3">
                  <a href="tel:+919836190771" className="font-semibold text-cyan-400 hover:text-cyan-300 transition-colors duration-200 block">📞 9836190771</a>
                  <a href="tel:+919831798000" className="font-semibold text-cyan-400 hover:text-cyan-300 transition-colors duration-200 block">📞 9831798000</a>
                  <a href="tel:+918481098000" className="font-semibold text-cyan-400 hover:text-cyan-300 transition-colors duration-200 block">📞 8481098000</a>
                  <a href="tel:+918482098000" className="font-semibold text-cyan-400 hover:text-cyan-300 transition-colors duration-200 block">📞 8482098000</a>
                </div>
                <p className="text-gray-400 mt-3">✉ yashcollection2@gmail.com</p>
              </div>
            </div>
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <a href="https://www.instagram.com/yashkidswear?igsh=cG5hZDdyMWdqNnhp" target="_blank" rel="noopener noreferrer"
                  ...
                  <a href="https://www.facebook.com/share/17aWSbirL9/" target="_blank" rel="noopener noreferrer"
